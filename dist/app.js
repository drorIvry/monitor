...
var cryptr = new _cryptr["default"]('myTotalySecretKey'); // mongoose.connect('mongodb://localhost/monitor', {useNewUrlParser: true, useUnifiedTopology: true});

_mongoose["default"].connect('mongodb://admin:a123456@ds031319.mlab.com:31319/pcmonitor', {
  useNewUrlParser: true,
  useUnifiedTopology: true
});

var db = _mongoose["default"].connection;
db.on('error', console.error.bind(console, 'connection error:')); // app.use(
